...
export class RatingAndComment1758020932466 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "product_ratings" ADD "parent_id" integer`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "product_ratings" DROP COLUMN "comment"`);
        await queryRunner.query(`ALTER TABLE "product_ratings" DROP COLUMN "parent_id"`);
    }
