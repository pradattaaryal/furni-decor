...
export class Images1760327470125 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "product_variants" RENAME COLUMN "color" TO "color_id"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "blogs" DROP CONSTRAINT "FK_1f073a9f9720fe731423f1064cc"`);
        await queryRunner.query(`ALTER TABLE "product_variants" DROP COLUMN "color_id"`);
        await queryRunner.query(`ALTER TABLE "product_variants" ADD "color_id" character varying(20) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "product_variants" RENAME COLUMN "color_id" TO "color"`);
