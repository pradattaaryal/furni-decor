...
export class Init1760673008104 implements MigrationInterface {
  name = 'Init1760673008104';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "products" ADD CONSTRAINT "FK_8984eaad3b517d30bbdf01d8057" FOREIGN KEY ("main_image_id") REFERENCES "image"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
