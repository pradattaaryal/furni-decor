...
export class Init1760673008104 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "blog_categories" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "name" character varying(255) NOT NULL, "slug" character varying(255) NOT NULL, "description" text, CONSTRAINT "UQ_adc3bc773ccf2fb6f073193fcf6" UNIQUE ("name"), CONSTRAINT "UQ_903a6ea496e83ba9bec10af5835" UNIQUE ("slug"), CONSTRAINT "PK_1056d6faca26b9957f5d26e6572" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_a176b739100e057522a10e36e0" ON "blog_categories" ("id") WHERE "deleted_at" IS NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_2c324bc456e89e48f9f2464d85" ON "blog_categories" ("id", "created_at") `);
        await queryRunner.query(`CREATE INDEX "IDX_adc3bc773ccf2fb6f073193fcf" ON "blog_categories" ("name") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_aaacd28c70b0183d8b3345b080" ON "blogs" ("id") WHERE "deleted_at" IS NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_1d0cd055ad7f4e0ab0a46a39f8" ON "blogs" ("id", "created_at") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_93da2ba8b760a219b7803815df" ON "order_items" ("id") WHERE "deleted_at" IS NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_e72f2444c146ac93f9641c5625" ON "order_items" ("id", "created_at") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('ORDER_PENDING', 'ORDER_COMPLETED', 'ORDER_CANCELLED')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_23798b69243926bb87a599e6d0" ON "orders" ("id", "created_at") `);
        await queryRunner.query(`CREATE TABLE "shipping_addresses" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "user_id" integer NOT NULL, "addressLine1" character varying(255) NOT NULL, "addressLine2" character varying(255), "city" character varying(100) NOT NULL, "state" character varying(100) NOT NULL, "postalCode" character varying(20) NOT NULL, "country" character varying(100) NOT NULL, "default" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_cced78984eddbbe24470f226692" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_6d8288bf6348c9ff32ed28cfe0" ON "shipping_addresses" ("id") WHERE "deleted_at" IS NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_ff4db4ba69cd1a87a183414538" ON "shipping_addresses" ("id", "created_at") `);
        ...
        await queryRunner.query(`CREATE TABLE "wishlists" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "user_id" integer NOT NULL, "product_id" integer NOT NULL, "variant_id" integer, CONSTRAINT "PK_d0a37f2848c5d268d315325f359" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_c72b364a0643e32b2ac566d5c0" ON "wishlists" ("id") WHERE "deleted_at" IS NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_f39c5724aa4e383106ec7cfa54" ON "wishlists" ("id", "created_at") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."payments_provider_enum" AS ENUM('stripe', 'paypal', 'square')`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_cbfb19ddc0218b26522f9fea2eb" FOREIGN KEY ("cart_id") REFERENCES "cart"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_f39c5724aa4e383106ec7cfa54"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c72b364a0643e32b2ac566d5c0"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ff4db4ba69cd1a87a183414538"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6d8288bf6348c9ff32ed28cfe0"`);
        await queryRunner.query(`DROP TABLE "shipping_addresses"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_23798b69243926bb87a599e6d0"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_e72f2444c146ac93f9641c5625"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_93da2ba8b760a219b7803815df"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_cf12321fa0b7b9539e89c7dfeb"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_61fb9349aae5a0b689f94a8db3"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_10bc9e2aa7c01881cd1f02ec16"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_1d0cd055ad7f4e0ab0a46a39f8"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_aaacd28c70b0183d8b3345b080"`);
        await queryRunner.query(`DROP TABLE "blogs"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_adc3bc773ccf2fb6f073193fcf"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2c324bc456e89e48f9f2464d85"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a176b739100e057522a10e36e0"`);
