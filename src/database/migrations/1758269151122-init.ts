...
export class Init1758269151122 implements MigrationInterface {
    name = 'Init1758269151122'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "image" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "path" character varying(255) NOT NULL, "filename" character varying(255) NOT NULL, "mime" character varying(50) NOT NULL, "size" bigint, "type" character varying(100), "product_id" integer, CONSTRAINT "PK_d6db1ab4ee9ad9dbe86c64e4cc3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_cf154a48ac328edeb8167a1cd7" ON "image" ("id") WHERE "deleted_at" IS NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_d66031207bb97bfd6fc53e8f57" ON "image" ("id", "created_at") `);
        await queryRunner.query(`CREATE INDEX "IDX_643e806cfd148c15e5d5982da7" ON "image" ("type") `);
        await queryRunner.query(`CREATE INDEX "IDX_dfac6399a9b7b8134c350af0b9" ON "image" ("type", "deleted_at") WHERE type = 'product_variants' AND deleted_at IS NULL`);
        await queryRunner.query(`CREATE TABLE "product_variants" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "dimensions" jsonb NOT NULL, "color" character varying(20) NOT NULL, "quantity" integer, "image_id" integer, "product_id" integer, CONSTRAINT "REL_80810e665ba660ed25412c5b8a" UNIQUE ("image_id"), CONSTRAINT "PK_281e3f2c55652d6a22c0aa59fd7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "cart_items" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "cart_id" integer NOT NULL, "product_id" integer NOT NULL, "variant_id" integer, "quantity" integer NOT NULL DEFAULT '1', "price" numeric(10,2) NOT NULL, CONSTRAINT "PK_6fccf5ec03c172d27a28a82928b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_121778e635712659db02c7cbc6" ON "cart" ("id") WHERE "deleted_at" IS NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_b968f19060a9af62784eb327fe" ON "cart" ("id", "created_at") `);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_b1aae736b7c5d6925efa8563527" FOREIGN KEY ("image_id") REFERENCES "image"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b968f19060a9af62784eb327fe"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_121778e635712659db02c7cbc6"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_eaad245682e9f8a3eb0f030e1b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_155c01468f41e508b5db2c5de1"`);
        await queryRunner.query(`DROP TABLE "product_variants"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_dfac6399a9b7b8134c350af0b9"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_643e806cfd148c15e5d5982da7"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d66031207bb97bfd6fc53e8f57"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_cf154a48ac328edeb8167a1cd7"`);
